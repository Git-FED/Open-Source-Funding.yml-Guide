...
> An enterprise subscription and maintenance model for packages used by organizations.

## What it is

Tidelift is a commercial distribution layer, not a consumer donation page.

## Payment rails

Enterprise contracting and maintainer payout terms apply.

## Fee lens

Revenue share is negotiated or model-specific. Fees are not static. Confirm the official pricing page before publishing a recommendation.
...
- **Recommended backup:** **GitHub Sponsors for independent support.**
